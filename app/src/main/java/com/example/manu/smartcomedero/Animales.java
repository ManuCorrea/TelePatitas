...
public class Animales extends android.support.v4.app.Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        cards.add(new Card(getString(R.string.animal_1), "nose"));
        cards.add(new Card("Paco", "3 años", "Se nos muere"));
